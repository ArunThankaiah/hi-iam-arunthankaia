  ...
  <div  className='lg:hidden block absolute top-16 w-full left-0 right-0 bg-slate-900 transition'>
    <ul className='text-center text-xl p-20'>
      ...
      <Link spy={true} smooth= {true} to='Skills'>
        <li className='my-4 py-4 border-b border-slate-800 hover:bg-slate-800 hover:rounded cursor-pointer'>Skills</li>
      </Link>

      
      <Link spy={true} smooth= {true} to='Projects'>
        <li className='my-4 py-4 border-b border-slate-800 hover:bg-slate-800 hover:rounde cursor-pointer'>Projects</li>
      </Link>
